...
for i in range(1,76):
    ...
    ## Accessing the zipfile i 获取压缩文件夹
    archive = zipfile.ZipFile("data/" + zipfilename, "r")
    zipfilename = zipfilename.split(".zip")[0]  # 去掉zip后缀 training80_01

    ##Extracting all videos in it and saving it all to the new folder with same name as zipped one
    ## 解压 并保存在unzippedData/路径下 unzippedData/training80_01   + zipfilename
    ...
    # archive.namelist() 获取压缩文件夹中的所有文件
