...
def test_data_to_TF(per_video=48):
    ...
    if len(image_addrs) != per_video * NUM_VID or len(wav_addrs) !=per_video * NUM_VID:
        print("TRAIN DATA LENGTH ERROR: ", len(image_addrs), len(wav_addrs))
        return
    ...
    train_filename = "Dr_train.tfrecords"  # address to save the TFRecords file
...
def val_data_to_TF(per_video=32):
    ...
    val_filename = "Dr_val.tfrecords"  # address to save the TFRecords file
    # open the TFRecords file
